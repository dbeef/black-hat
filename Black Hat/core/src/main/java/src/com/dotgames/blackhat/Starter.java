package src.com.dotgames.blackhat;
...
public class Starter extends ApplicationAdapter {
	...
	final String vertexShader = new FileHandle("assets/vertexShader.glsl").readString();
	final String defaultPixelShader = new FileHandle("assets/defaultPixelShader.glsl").readString();
	final String ambientPixelShader = new FileHandle("assets/ambientPixelShader.glsl").readString();
	final String lightPixelShader =  new FileHandle("assets/lightPixelShader.glsl").readString();
	final String finalPixelShader =  new FileHandle("assets/pixelShader.glsl").readString();
	...
	public void create () {
		...
		monitor = new Texture("assets/monitor.png");
		ekran = new Texture("assets/ekran.png");
		env = new Texture("assets/env.png");
		interfere = new Texture("assets/interfere.png");
		...
		bitmapFont = new BitmapFont(Gdx.files.internal("assets/clasconsole.fnt"),false);
		...
		//
		FreeTypeFontGenerator generator = new FreeTypeFontGenerator(Gdx.files.internal("assets/prstart.ttf"));
